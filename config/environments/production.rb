Rails.application.configure do
  ...
  config.force_ssl = true if Rails.env.production? && ENV['RAILS_IGNORE_SSL'].blank?
  ...
  config.action_mailer.asset_host = "https://bbsmile.com.ua"
  ...
  # config.active_job.queue_name_prefix = "bbsmile_#{Rails.env}"
